...
function NewProductPage() {
	...
	const formSchema = z.object({
		name: z.string().min(1, { message: t("products.new.errors.nameRequired") }),
		description: z
			.string()
			.min(1, { message: t("products.new.errors.descriptionRequired") }),
		price: z
			.string()
			.min(1, { message: t("products.new.errors.priceRequired") })
			.refine((value) => Number.isFinite(Number(value)) && Number(value) >= 0, {
				message: t("products.new.errors.priceInvalid"),
			}),
		categoryId: z
			.string()
			.min(1, { message: t("products.new.errors.categoryRequired") }),
